                                ...
                                <div className="col-lg-4 col-sm-6">
                                    <div className="about-text">
                                        ...
                                        <ul className="features-list">
                                            <li><i className='bx bx-check'></i> People like Jupiter</li>
                                            <li><i className='bx bx-check'></i> World's finest Jupiter</li>
                                            <li><i className='bx bx-check'></i> The original Jupiter</li>
                                            <li><i className='bx bx-check'></i> We trust Jupiter</li>
                                        </ul>
                                    </div>
                                </div>
